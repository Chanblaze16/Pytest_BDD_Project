...
dropdown_account_name_xpath = "(//lightning-base-combobox-formatted-text[@title='Chandru'])[1]"
...
dropdown_account_name_xpath1 = "(//lightning-base-combobox-formatted-text[@title='Chandru'])[1]"
...
contact_created = "//article[contains(@aria-label, 'Chandru Siva')]"
